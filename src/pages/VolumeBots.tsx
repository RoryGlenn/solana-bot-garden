...
// Filtered mock data for volume bots
const generateVolumeBots = (): Bot[] => {
  return [
    {
      id: '1',
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-8" {...animationProps}>
            ...
            <Button 
              ...
              onClick={() => navigate('/volume-bots/create')}
            >
