...
// Filtered mock data for trade bots
const generateTradeBots = (): Bot[] => {
  return [
    {
      id: '3',
        ...
        <div className="p-6">
          <div className="flex items-center justify-between mb-8" {...animationProps}>
            ...
            <Button 
              ...
              onClick={() => navigate('/trade-bots/create')}
            >
            ...
            <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
              {bots.length > 0 ? (
                ...
                <div className="col-span-3 text-center py-12">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Trade Bots Yet</h3>
                  <p className="text-muted-foreground mb-6">Create your first trade bot to start executing custom trading strategies.</p>
                  <Button 
                    className="bg-gradient-to-r from-solana to-accent hover:shadow-lg transition-all duration-300"
                    onClick={() => navigate('/trade-bots/create')}
                  >
